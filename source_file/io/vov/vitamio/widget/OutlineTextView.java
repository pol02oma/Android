...
public class OutlineTextView extends TextView
{
  ...
  private int measureHeight(int paramInt)
  {
    ...
    {
      return k;
      k = (int)(-this.mAscent + this.mTextPaintOutline.descent()) + getPaddingTop() + getPaddingBottom();
    }
    while (i != -2147483648);
    return Math.min(k, j);
  }
  ...
  private int measureWidth(int paramInt)
  {
    ...
    {
      return k;
      k = (int)this.mTextPaintOutline.measureText(this.mText) + getPaddingLeft() + getPaddingRight();
    }
    while (i != -2147483648);
    return Math.min(k, j);
  }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    int i = (int)(1.0F + 2.0F * this.mBorderSize);
    setMeasuredDimension(i + measureWidth(paramInt1), i + measureHeight(paramInt2) * localStaticLayout.getLineCount());
  }
