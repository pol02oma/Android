  ...
  public Map<String, List<String>> a(String paramString)
  {
    ...
    if (j < i)
    {
      ...
      if (arrayOfString2.length != 2)
        ex.a(5, a, "Invalid referrer Element: " + arrayOfString1[j] + " in referrer tag " + paramString);
      while (true)
      {
        j++;
        break;
    ...
    while (localIterator.hasNext())
    {
      ...
      ex.a(3, a, "entry: " + (String)localEntry.getKey() + "=" + localEntry.getValue());
    }
    ...
    if (localStringBuilder.length() > 0)
      ex.a(5, a, "Detected missing referrer keys : " + localStringBuilder.toString());
    return localHashMap;
  }
}
