...
public final class PlusShare
{
  ...
  protected static boolean aO(String paramString)
  {
  ...
  public static Person createPerson(String paramString1, String paramString2)
  {
    ...
    return new ir(paramString2, paramString1, null, 0, null);
  }
  ...
  public static class Builder
  {
    ...
    public Builder(Activity paramActivity, PlusClient paramPlusClient)
    {
      ...
      {
        bool = true;
        er.a(bool, "PlusClient must not be null.");
        er.a(paramPlusClient.isConnected(), "PlusClient must be connected to create an interactive post.");
        er.a(paramPlusClient.hj().aR("https://www.googleapis.com/auth/plus.login"), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
    ...
    public Builder addCallToAction(String paramString1, Uri paramUri, String paramString2)
    {
      ...
      {
        er.b(bool, "Must provide a call to action URL");
        Bundle localBundle = new Bundle();
        if (!TextUtils.isEmpty(paramString1))
        ...
        if (!TextUtils.isEmpty(paramString2))
        {
          er.a(PlusShare.aO(paramString2), "The specified deep-link ID was malformed.");
    ...
    public Builder addStream(Uri paramUri)
    {
      ...
      this.Rc.add(localUri);
      this.Rc.add(paramUri);
      return this;
    }
    ...
    public Intent getIntent()
    {
      ...
      if ((this.Rc != null) && (this.Rc.size() > i))
      {
        ...
        if ((k != 0) && (bool2))
          break label302;
        int n = i;
        label59: er.a(n, "Call-to-action buttons are only available for URLs.");
        if ((bool2) && (!this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_URL")))
          break label308;
        int i2 = i;
        label86: er.a(i2, "The content URL is required for interactive posts.");
        if ((bool2) && (!this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_URL")) && (!this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")))
          break label314;
        label122: er.a(i, "Must set content URL or content deep-link ID to use a call-to-action button.");
        if (this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID"))
          er.a(PlusShare.aO(this.mIntent.getStringExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")), "The specified deep-link ID was malformed.");
        if ((k == 0) && (bool1))
        {
    ...
    {
      er.b(this.Rb, "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
      if (!TextUtils.isEmpty(paramString1));
      for (boolean bool = true; ; bool = false)
      {
        er.b(bool, "The deepLinkId parameter is required.");
