...
public class AppPushNotificationDialogLayout extends FrameLayout
{
  ...
  private void initialize()
  {
    ...
    while (true)
    {
      ...
      localImageView2.setImageBitmap(BitmapFactory.decodeStream(getClass().getResourceAsStream("/com/appbuilder/sdk/android/res/push_dialog_btn_close.png")));
      ...
      break;
      label683: localImageView1.setVisibility(0);
      Bitmap localBitmap = BitmapFactory.decodeFile(this.imgPath);
      if (localBitmap != null)
      {
        localImageView1.setImageBitmap(localBitmap);
        LinearLayout.LayoutParams localLayoutParams4 = new LinearLayout.LayoutParams((int)(0.9D * this.screenWidth) - i, (int)(0.9D * this.screenWidth) - i);
        if (TextUtils.isEmpty(this.titleText))
 ...
 * Qualified Name:     com.appbuilder.sdk.android.pushnotification.AppPushNotificationDialogLayout
