...
public class TableReservationMapBottomPanel extends LinearLayout
{
  ...
  public TableReservationMapBottomPanel(Context paramContext)
  {
    super(paramContext);
    init();
  }

  public TableReservationMapBottomPanel(Context paramContext, AttributeSet paramAttributeSet)
  {
 ...
 * Qualified Name:     com.ibuildapp.romanblack.TableReservationPlugin.TableReservationMapBottomPanel
