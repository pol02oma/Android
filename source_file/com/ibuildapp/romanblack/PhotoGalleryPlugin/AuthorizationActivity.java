  ...
  implements View.OnClickListener, View.OnFocusChangeListener, TextWatcher
{
  ...
  private Handler handler = new Handler()
  {
    public void handleMessage(Message paramMessage)
    {
      ...
      Toast.makeText(AuthorizationActivity.this, AuthorizationActivity.this.getResources().getString(R.string.romanblack_photogallery_signup_failed), 1).show();
    }
  };
  ...
  public void create()
  {
    setContentView(R.layout.romanblack_photogallery_authorization_main);
    ...
    this.btnFacebookAuth = ((LinearLayout)findViewById(R.id.romanblack_photogallery_login_facebookbtn));
    this.btnFacebookAuth.setOnClickListener(this);
    this.btnTwitterAuth = ((LinearLayout)findViewById(R.id.romanblack_photogallery_login_twitterbtn));
    this.btnTwitterAuth.setOnClickListener(this);
    this.btnEmailAuth = ((LinearLayout)findViewById(R.id.romanblack_photogallery_login_emailbtn));
    this.btnEmailAuth.setOnClickListener(this);
    this.btnEmailAuthTextView = ((TextView)findViewById(R.id.romanblack_photogallery_login_emailbtn_text));
    this.btnEmailAuthTextView.setText(Html.fromHtml("<u>" + getString(R.string.romanblack_photogallery_have_an_account) + "</u>"));
    this.btnSignUp = ((TextView)findViewById(R.id.romanblack_photogallery_login_signuplabel));
    this.btnSignUp.setOnClickListener(this);
    this.emailEditText = ((EditText)findViewById(R.id.romanblack_photogallery_login_email));
    this.emailEditText.addTextChangedListener(this);
    this.passwordEditText = ((EditText)findViewById(R.id.romanblack_photogallery_login_password));
    ...
    do
      while (true)
      {
        ...
        do
          return;
        while (paramInt2 != 0);
        Toast.makeText(this, getString(R.string.romanblack_photogallery_alert_facebook_authorization_failed), 1).show();
        return;
        if (paramInt1 == 10001)
        {
          if (paramInt2 == -1)
          ...
          if (paramInt2 != 0)
            continue;
          Toast.makeText(this, getString(R.string.romanblack_photogallery_alert_twitter_authorization_failed), 1).show();
          return;
        }
        if (paramInt1 != 10002)
          break;
  ...
  public void onClick(View paramView)
  {
    if (paramView.getId() == R.id.romanblack_photogallery_login_facebookbtn)
      Authorization.authorize(this, 10000, 1);
    do
      while (true)
      {
        return;
        if (paramView.getId() == R.id.romanblack_photogallery_login_twitterbtn)
        {
          Authorization.authorize(this, 10001, 2);
          return;
        }
        if (paramView.getId() == R.id.romanblack_photogallery_login_emailbtn)
        {
          startActivityForResult(new Intent(this, EMailAuthorizationActivity.class), 10002);
          return;
        }
        if (paramView.getId() != R.id.romanblack_photogallery_login_signuplabel)
          break;
    ...
    while (paramView.getId() != R.id.romanblack_login_home);
    finish();
  }
 ...
 * Qualified Name:     com.ibuildapp.romanblack.PhotoGalleryPlugin.AuthorizationActivity
