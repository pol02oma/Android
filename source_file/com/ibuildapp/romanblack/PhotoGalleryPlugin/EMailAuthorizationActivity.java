  ...
  implements View.OnClickListener, View.OnFocusChangeListener
{
  ...
  public void onClick(View paramView)
  {
    if (paramView.getId() == R.id.romanblack_login_home)
      finish();
    do
      while (true)
      {
        return;
        if (paramView.getId() == R.id.romanblack_photogallery_emailauth_btn_sugnup)
        {
        ...
        if (paramView.getId() != R.id.romanblack_photogallery_emailauth_fname)
          break;
    ...
    while ((paramView.getId() != R.id.romanblack_photogallery_emailauth_lname) || (!this.passwordEditText.getText().toString().equals(this.DEFAULT_PASSWORD_TEXT)));
  ...
  public void onFocusChange(View paramView, boolean paramBoolean)
  {
    ...
    do
      while (true)
      {
        ...
        return;
        if (paramView.getId() != R.id.romanblack_photogallery_emailauth_lname)
          continue;
        if (!paramBoolean)
          break;
 ...
 * Qualified Name:     com.ibuildapp.romanblack.PhotoGalleryPlugin.EMailAuthorizationActivity
