  ...
  implements Status, Serializable
{
    ...
    throws TwitterException
  {
    ...
    try
    {
      ...
      label707: HashtagEntity[] arrayOfHashtagEntity;
      label726: SymbolEntity[] arrayOfSymbolEntity;
      if (this.userMentionEntities == null)
      {
        ...
        label745: this.symbolEntities = arrayOfSymbolEntity;
        if (this.mediaEntities != null)
          break label862;
      }
      label835: label844: label853: label862: for (MediaEntity[] arrayOfMediaEntity = new MediaEntity[0]; ; arrayOfMediaEntity = this.mediaEntities)
      {
