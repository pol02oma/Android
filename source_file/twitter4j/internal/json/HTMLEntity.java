...
final class HTMLEntity
{
  ...
  static java.lang.String unescapeAndSlideEntityIncdices(java.lang.String paramString, UserMentionEntity[] paramArrayOfUserMentionEntity, URLEntity[] paramArrayOfURLEntity, HashtagEntity[] paramArrayOfHashtagEntity, MediaEntity[] paramArrayOfMediaEntity)
  {
    ...
    if (paramArrayOfUserMentionEntity == null)
    {
      ...
      if (-1 == i8)
        break label361;
      java.lang.String str1 = paramString.substring(i6, i8 + 1);
      java.lang.String str2 = (java.lang.String)escapeEntityMap.get(str1);
      if (str2 == null)
        break label347;
      ...
      i6 = i8;
      i7 = 1 - str1.length();
      label265: if (i5 < arrayOfEntityIndex.length)
      {
        if (i4 == 0)
          break label389;
        if (arrayOfEntityIndex[i5].getStart() == i7 + i6)
        {
    ...
    while (true)
    {
      ...
      break;
      label325: k = paramArrayOfURLEntity.length;
      break label20;
      label332: n = paramArrayOfHashtagEntity.length;
      break label34;
      label339: i2 = paramArrayOfMediaEntity.length;
      break label49;
      label347: localStringBuilder.append(c);
      i7 = 0;
      break label265;
      label361: localStringBuilder.append(c);
      i7 = 0;
      break label265;
      label375: localStringBuilder.append(c);
      i7 = 0;
      break label265;
      label389: if (arrayOfEntityIndex[i5].getEnd() != i7 + i6)
        continue;
      arrayOfEntityIndex[i5].setEnd(-1 + localStringBuilder.length());
      i5++;
      i4 = 1;
    }
    label429: if ((i5 < arrayOfEntityIndex.length) && (arrayOfEntityIndex[i5].getEnd() == paramString.length()))
