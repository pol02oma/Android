  ...
  implements Place, Serializable
{
    ...
    while (true)
    {
      ...
      try
      {
        ...
        if (!paramJSONObject.isNull("bounding_box"))
        {
          ...
          this.containedWithIn = new Serializable[localJSONArray1.length()];
          int i = 0;
      ...
      continue;
      label403: this.geometryType = null;
      this.geometryCoordinates = ((GeoLocation[][])null);
    }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    do
      return i;
    while ((this == paramObject) || (((paramObject instanceof Serializable)) && (((Serializable)paramObject).getId().equals(this.id))));
    return false;
  }
