  ...
  implements OAuthProvider
{
    ...
    throws OAuthMessageSignerException, OAuthCommunicationException, OAuthNotAuthorizedException, OAuthExpectationFailedException
  {
    ...
    //   40: aload_0
    //   41: aload_2
    //   42: invokevirtual 193	oauth/signpost/AbstractOAuthProvider:createRequest	(Ljava/lang/String;)Loauth/signpost/http/HttpRequest;
    //   45: astore 5
    //   47: aload 4
    ...
    //   122: aload 5
    //   124: aload 6
    //   126: invokevirtual 225	oauth/signpost/AbstractOAuthProvider:closeConnection	(Loauth/signpost/http/HttpRequest;Loauth/signpost/http/HttpResponse;)V
    //   129: aload 8
    //   131: athrow
    //   132: aload_3
    //   133: ifnull +27 -> 160
    ...
    //   147: aload_3
    //   148: iconst_1
    //   149: invokevirtual 229	oauth/signpost/http/HttpParameters:putAll	([Ljava/lang/String;Z)V
    //   152: aload_1
    //   153: aload 29
    ...
    //   219: aload_0
    //   220: aload 5
    //   222: invokevirtual 250	oauth/signpost/AbstractOAuthProvider:sendRequest	(Loauth/signpost/http/HttpRequest;)Loauth/signpost/http/HttpResponse;
    //   225: astore 6
    //   227: aload 6
    ...
    //   275: aload 5
    //   277: aload 6
    //   279: invokevirtual 225	oauth/signpost/AbstractOAuthProvider:closeConnection	(Loauth/signpost/http/HttpRequest;Loauth/signpost/http/HttpResponse;)V
    //   282: return
    //   283: astore 28
    //   285: new 94	oauth/signpost/exception/OAuthCommunicationException
    //   288: dup
    //   289: aload 28
    //   291: invokespecial 261	oauth/signpost/exception/OAuthCommunicationException:<init>	(Ljava/lang/Exception;)V
    //   294: athrow
    //   295: iload 18
    //   297: sipush 300
    ...
    //   304: iload 18
    //   306: aload 6
    //   308: invokevirtual 263	oauth/signpost/AbstractOAuthProvider:handleUnexpectedResponse	(ILoauth/signpost/http/HttpResponse;)V
    //   311: aload 6
    //   313: invokeinterface 76 1 0
    //   318: invokestatic 267	oauth/signpost/OAuth:decodeForm	(Ljava/io/InputStream;)Loauth/signpost/http/HttpParameters;
    //   321: astore 22
    //   323: aload 22
    //   325: ldc 175
    ...
    //   332: aload 22
    //   334: ldc_w 269
    //   337: invokevirtual 62	oauth/signpost/http/HttpParameters:getFirst	(Ljava/lang/Object;)Ljava/lang/String;
    //   340: astore 24
    //   342: aload 22
    //   344: ldc 175
    //   346: invokevirtual 162	oauth/signpost/http/HttpParameters:remove	(Ljava/lang/Object;)Ljava/util/SortedSet;
    //   349: pop
    //   350: aload 22
    //   352: ldc_w 269
    //   355: invokevirtual 162	oauth/signpost/http/HttpParameters:remove	(Ljava/lang/Object;)Ljava/util/SortedSet;
    //   358: pop
    //   359: aload_0
    //   360: aload 22
    //   362: invokevirtual 272	oauth/signpost/AbstractOAuthProvider:setResponseParameters	(Loauth/signpost/http/HttpParameters;)V
    //   365: aload 23
    //   367: ifnull +8 -> 375
    //   370: aload 24
    //   372: ifnonnull +19 -> 391
    //   375: new 130	oauth/signpost/exception/OAuthExpectationFailedException
    //   378: dup
    //   379: ldc_w 274
    //   382: invokespecial 141	oauth/signpost/exception/OAuthExpectationFailedException:<init>	(Ljava/lang/String;)V
    //   385: athrow
    //   386: astore 10
    //   388: aload 10
    //   390: athrow
    ...
    //   402: aload 5
    //   404: aload 6
    //   406: invokevirtual 225	oauth/signpost/AbstractOAuthProvider:closeConnection	(Loauth/signpost/http/HttpRequest;Loauth/signpost/http/HttpResponse;)V
    //   409: return
    //   410: astore 27
    //   412: new 94	oauth/signpost/exception/OAuthCommunicationException
    //   415: dup
    //   416: aload 27
    //   418: invokespecial 261	oauth/signpost/exception/OAuthCommunicationException:<init>	(Ljava/lang/Exception;)V
    //   421: athrow
    //   422: astore 7
    //   424: new 94	oauth/signpost/exception/OAuthCommunicationException
    //   427: dup
    //   428: aload 7
    //   430: invokespecial 261	oauth/signpost/exception/OAuthCommunicationException:<init>	(Ljava/lang/Exception;)V
    //   433: athrow
    //   434: astore 9
    //   436: new 94	oauth/signpost/exception/OAuthCommunicationException
    //   439: dup
    //   440: aload 9
    //   442: invokespecial 261	oauth/signpost/exception/OAuthCommunicationException:<init>	(Ljava/lang/Exception;)V
    //   445: athrow
    //
    // Exception table:
    //   from	to	target	type
    ...
    //   311	365	114	oauth/signpost/exception/OAuthNotAuthorizedException
    //   375	386	114	oauth/signpost/exception/OAuthNotAuthorizedException
    //   391	401	114	oauth/signpost/exception/OAuthNotAuthorizedException
    //   40	61	119	finally
    //   61	70	119	finally
    //   78	111	119	finally
    //   116	119	119	finally
    ...
    //   40	61	386	oauth/signpost/exception/OAuthExpectationFailedException
    //   61	70	386	oauth/signpost/exception/OAuthExpectationFailedException
    //   78	111	386	oauth/signpost/exception/OAuthExpectationFailedException
    //   136	160	386	oauth/signpost/exception/OAuthExpectationFailedException
    //   160	166	386	oauth/signpost/exception/OAuthExpectationFailedException
    //   174	185	386	oauth/signpost/exception/OAuthExpectationFailedException
    //   185	200	386	oauth/signpost/exception/OAuthExpectationFailedException
    //   208	219	386	oauth/signpost/exception/OAuthExpectationFailedException
    //   219	242	386	oauth/signpost/exception/OAuthExpectationFailedException
    //   250	265	386	oauth/signpost/exception/OAuthExpectationFailedException
    //   303	311	386	oauth/signpost/exception/OAuthExpectationFailedException
    //   311	365	386	oauth/signpost/exception/OAuthExpectationFailedException
    //   375	386	386	oauth/signpost/exception/OAuthExpectationFailedException
    //   391	401	386	oauth/signpost/exception/OAuthExpectationFailedException
