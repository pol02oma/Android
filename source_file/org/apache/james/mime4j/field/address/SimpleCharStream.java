...
public class SimpleCharStream
{
  ...
  public char[] GetSuffix(int paramInt)
  {
    ...
    System.arraycopy(this.buffer, this.bufsize - (-1 + (paramInt - this.bufpos)), arrayOfChar, 0, -1 + (paramInt - this.bufpos));
    System.arraycopy(this.buffer, 0, arrayOfChar, -1 + (paramInt - this.bufpos), 1 + this.bufpos);
    return arrayOfChar;
  }
 ...
 * Qualified Name:     org.apache.james.mime4j.field.address.SimpleCharStream
