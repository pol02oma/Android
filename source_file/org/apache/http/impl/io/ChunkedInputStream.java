...
public class ChunkedInputStream extends InputStream
{
  ...
  private void parseTrailerHeaders()
    throws IOException
  {
    MalformedChunkCodingException localMalformedChunkCodingException;
    try
    {
    ...
    {
      localMalformedChunkCodingException = new MalformedChunkCodingException("Invalid footer: " + localHttpException.getMessage());
