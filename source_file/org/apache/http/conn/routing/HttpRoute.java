  ...
  implements RouteInfo, Cloneable
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    while (true)
    {
      ...
      if ((this.secure != localHttpRoute.secure) || (this.tunnelled != localHttpRoute.tunnelled) || (this.layered != localHttpRoute.layered) || (!LangUtils.equals(this.targetHost, localHttpRoute.targetHost)) || (!LangUtils.equals(this.localAddress, localHttpRoute.localAddress)) || (!LangUtils.equals(this.proxyChain, localHttpRoute.proxyChain)))
        return false;
    }
    return false;
  }
