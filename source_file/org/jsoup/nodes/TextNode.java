...
public class TextNode extends Node
{
  ...
  void outerHtmlHead(StringBuilder paramStringBuilder, int paramInt, Document.OutputSettings paramOutputSettings)
  {
    ...
    if ((paramOutputSettings.prettyPrint()) && ((parent() instanceof Element)) && (!((Element)parent()).preserveWhitespace()))
      str = normaliseWhitespace(str);
    if ((paramOutputSettings.prettyPrint()) && (siblingIndex() == 0) && ((this.parentNode instanceof Element)) && (((Element)this.parentNode).tag().formatAsBlock()) && (!isBlank()))
