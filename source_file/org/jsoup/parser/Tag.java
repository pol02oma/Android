...
public class Tag
{
  ...
  static
  {
    ...
    for (String str3 : emptyTags)
    {
      ...
      localTag4.canContainBlock = false;
      localTag4.canContainInline = false;
      localTag4.empty = true;
    }
    for (String str2 : formatAsInlineTags)
    {
      Tag localTag3 = (Tag)tags.get(str2);
      Validate.notNull(localTag3);
      localTag3.formatAsBlock = false;
    }
    for (String str1 : preserveWhitespaceTags)
    {
      Tag localTag2 = (Tag)tags.get(str1);
      Validate.notNull(localTag2);
      localTag2.preserveWhitespace = true;
    }
  }
  ...
  private static Tag register(Tag paramTag)
  {
    synchronized (tags)
    {
